...
export default function Home() {
  return (
    <>
      <Cursor />
      <NavBar />
      <div id="home" className="max-w-screen-xl mx-auto h-150 flex items-end justify-between relative">
        <div className="w-1/2 h-1/3 ">
          <div className="flex-row">
            <h1 className="text-5xl font-extrabold text-left">
              <Typing/>
            </h1>
            <h1 className="text-xl text-neutral-500 italic text-left pt-7">
              Segmentation faults build character.
            </h1>
          </div>
        </div>
        <div className="h-2/3 flex items-end">
          <Image width={350} height={350}className="rounded-full" src="/images/foto_perfil.jpg" alt="Profile Photo" />
        </div>
      </div>
      ...
      <section id="projects" className="pt-30 mb-30 max-w-screen-xl mx-auto h-150 flex items-start justify-center">
        <div className="max-w-screen-lg h-2/3">
      ...
      <section id="footer" className="w-full h-10 flex flex-col items-center justify-center mb-7 gap-5">
        <div className="w-1/5 flex justify-around items-center">
          <a href="https://github.com/2101dudu" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://linkedin.com/in/fariaeduardo" target="_blank" rel="noopener noreferrer">
          ...
          <a href="mailto:business@eduardofaria.pt">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M3.75 5.25L3 6V18L3.75 18.75H20.25L21 18V6L20.25 5.25H3.75ZM4.5 7.6955V17.25H19.5V7.69525L11.9999 14.5136L4.5 7.6955ZM18.3099 6.75H5.68986L11.9999 12.4864L18.3099 6.75Z" fill="#080341"/></svg>
          </a>
        </div>
